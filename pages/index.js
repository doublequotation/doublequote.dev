        ...
        <main>
            ...
            <article className={styles["market-text"]}>
                <div id={styles["text-1"]}>
                    ...
                    <p>
                        <b>Double quote</b> allows you to store make your own
                        cloud envirorment or host it with us.
                    </p>
                </div>
                <div id={styles["text-2"]}>
                    <h2>Open source</h2>
                    <p>
                        <b>Double quote</b> is compeletely open source! Every
                        line of code is all open to the public.
                    </p>
            ...
            <footer className="foot">
                <a href="https://github.com/doublequotation/" target="_blank">
                    Github
                </a>
            </footer>
        </main>
